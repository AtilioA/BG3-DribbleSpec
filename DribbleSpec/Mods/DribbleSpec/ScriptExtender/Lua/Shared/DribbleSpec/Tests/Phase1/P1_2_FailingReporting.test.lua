...
DribbleSpec.describe("DribbleSpec Phase1 P1.2 failing reporting", { tags = { "unit", "phase1" } }, function()
    DribbleSpec.test("captures failed test error message and stack", function()
