...
DribbleSpec.describe("DribbleSpec Phase1 P1.8 beforeAll failure", { tags = { "unit", "phase1" } }, function()
    DribbleSpec.test("marks remaining suite tests as skipped when beforeAll fails", function()
